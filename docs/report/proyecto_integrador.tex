...
\begin{table}[H]
	...
	\begin{tabular}{lcc}
		...
		\midrule
		0.0 (\textit{Sin diabetes}) & 84.24 & 213\,703 \\
		2.0 (\textit{Con diabetes}) & 13.93 & 35\,346 \\
		1.0 (\textit{Prediabetes})  & 1.83  & 4\,631 \\
		\bottomrule
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{lcc}
		...
		\textbf{Valor} & \textbf{Porcentaje (\%)} & \textbf{Cantidad de registros} \\
		\midrule
		0.0 (\textit{Sin diabetes}) & 85.81 & 213\,703 \\
		1.0 (\textit{Con diabetes}) & 14.19 & 35\,346 \\
		\bottomrule
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{lcccc}
		...
		\midrule
		\textit{Accuracy} & 0.5362 & -- & -- & -- \\
		\textit{Precision} & 0.2638 & -- & -- & -- \\
		\textit{Recall} & 0.7484 & -- & -- & -- \\
		\textit{Specificity} & 0.4838 & -- & -- & -- \\
		\textit{Balanced Accuracy} & 0.6161 & -- & -- & -- \\
		\textit{F1\_Score} & 0.3901 & -- & -- & -- \\
		\bottomrule
	\end{tabular}
