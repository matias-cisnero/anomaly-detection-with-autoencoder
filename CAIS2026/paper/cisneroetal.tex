...
El diagnóstico temprano de enfermedades como el cáncer de mama es una tarea prioritaria en la medicina moderna.
...
Este trabajo se basa en la hipótesis de que al entrenar el Autoencoder unicamente con datos normales, los registros anómalos (malignos) tendrán un mayor error de reconstrucción $\lVert \hat{t} - t \rVert$ en comparación con los normales (benignos). Este umbral de decisión se calcula con el índice de Youden.
